    ...
    <form-wizard @onComplete="onComplete">
      ...
      <tab-content title="Step 2">
        <div class="form-group">
          ...
          <div v-if="hasError('images')" class="invalid-feedback d-block">
...
export default {
  ...
  methods: {
    ...
    onComplete() {
      let date_format = new Date(this.formData.date_time);
      this.formData.date_time = format(date_format, "yyyy-MM-dd HH:mm");
